        ...
        return http
                ...
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers(
                                ...
                                new AntPathRequestMatcher("/api/v1/auth/refresh-access", "POST"),
                                new AntPathRequestMatcher("/api/v3/auth/login", "POST")
                        )
                )
                .authorizeHttpRequests(authorize -> authorize
                        // Allow CORS preflight requests to be accessed without authentication
                        ...
                        // Actuator public (liveness/readiness/info + prometheus)
