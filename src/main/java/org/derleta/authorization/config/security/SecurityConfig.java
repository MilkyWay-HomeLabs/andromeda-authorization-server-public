...
import org.derleta.authorization.config.repository.TokensGeneratorRepository;
import org.derleta.authorization.config.security.jwt.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.addAllowedOriginPattern("https://*.milkyway");
        configuration.addAllowedOriginPattern("https://*.test.milkyway");
        configuration.addAllowedOriginPattern("https://*.dev.milkyway");
        configuration.addAllowedOriginPattern("http://*.milkyway");
        configuration.addAllowedOriginPattern("http://*.test.milkyway");
        configuration.addAllowedOriginPattern("http://*.dev.milkyway");
