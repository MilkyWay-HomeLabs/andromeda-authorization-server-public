...
import org.derleta.authorization.service.accounts.AccountsService;
import org.derleta.authorization.service.accounts.process.ChangePasswordProcess;
import org.derleta.authorization.service.accounts.process.CreateConfirmationProcess;
...
public class AccountsServiceImpl implements AccountsService {
    ...
    public AccountsServiceImpl(
            AccountProcessFactory accountProcessFactory,
    ...
    private Set<RepositoryClass> repos(RepositoryClass... repos) {
        return new HashSet<>(Set.of(repos));
    }
    ...
    public AccountResponse register(final UserRegistrationRequest request) {
        AccountProcess accountProcess = accountProcessFactory.create(AccountProcessType.USER_REGISTRATION);
    ...
    public AccountResponse confirm(final UserConfirmationRequest request) {
        AccountProcess accountProcess = accountProcessFactory.create(AccountProcessType.CONFIRMATION_TOKEN);
    ...
    public AccountResponse unlock(final UserUnlockRequest request) {
        AccountProcess accountProcess = accountProcessFactory.create(AccountProcessType.UNLOCK_ACCOUNT);
    ...
    public AccountResponse resetPassword(final ResetPasswordRequest request) {
        AccountProcess accountProcess = accountProcessFactory.create(AccountProcessType.RESET_PASSWORD);
    ...
    public AccountResponse updatePassword(final ChangePasswordRequest request) {
        AccountProcess accountProcess = accountProcessFactory.create(AccountProcessType.CHANGE_PASSWORD);
