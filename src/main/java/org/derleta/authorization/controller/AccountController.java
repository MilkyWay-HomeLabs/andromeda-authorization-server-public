...
public class AccountController {
     ...
     * @return a ResponseEntity containing an AccountResponse object, which indicates the success or failure of the operation
     */
    @PatchMapping(value = "/" + DEFAULT_PATH + "/reset-password", produces = MediaTypes.HAL_JSON_VALUE)
    public ResponseEntity<AccountResponse> resetPassword(@RequestParam String email) {
