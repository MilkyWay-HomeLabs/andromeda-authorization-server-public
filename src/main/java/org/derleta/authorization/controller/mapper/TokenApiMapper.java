...
import org.derleta.authorization.domain.builder.impl.AccessTokenBuilderImpl;
import org.derleta.authorization.domain.builder.impl.ConfirmationTokenBuilderImpl;
import org.derleta.authorization.domain.builder.impl.RefreshTokenBuilderImpl;
...
public final class TokenApiMapper {
     ...
     * This method uses a builder pattern for the creation of the {@link RefreshToken}.
