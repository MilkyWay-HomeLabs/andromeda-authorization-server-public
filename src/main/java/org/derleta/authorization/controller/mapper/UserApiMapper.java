...
import org.derleta.authorization.domain.builder.impl.UserBuilderImpl;
...
public final class UserApiMapper {
    ...
    /**
     * Converts the given user data from a {@link UserRequest} into a {@link User} object.
     *
     * @param userRequest the request containing the user's username, password, and email
     * @return a {@link User} instance with the data from the user request
     */
    public static User toUserFromRequest(UserRequest userRequest) {
    ...
    public static User toUserPatch(final UserRequest userRequest) {
        if (userRequest == null) return null;
    ...
    public static UserEntity toUserEntity(final UserRegistrationRequest request) {
