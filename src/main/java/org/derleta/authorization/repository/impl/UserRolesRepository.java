...
import org.derleta.authorization.repository.mapper.RoleMapper;
...
public class UserRolesRepository implements RepositoryClass {
    ...
    private static final String DEFAULT_SORT_BY = "r.role_id";
    ...
    public List<UserRoleEntity> get(final long userId,
                                    final String sortByParam,
                                    final String sortOrderParam,
                                    final String roleName) {

        final String sortBy = (sortByParam == null || sortByParam.isBlank()) ? DEFAULT_SORT_BY : sortByParam;
        final String sortOrder = (sortOrderParam == null || sortOrderParam.isBlank()) ? DEFAULT_SORT_ORDER : sortOrderParam;

        final String sql = buildQueryForSortedList(sortBy, sortOrder);

        final String roleNameValue = (roleName == null) ? "" : roleName;
        final String roleNameParam = "%" + roleNameValue + "%";

        return jdbcTemplate.query(sql, new UserRoleMapper(), userId, roleNameParam);
    }
    ...
    private static String buildQueryForSortedList(final String sortBy, final String sortOrder) {
        ...
        final SortParameters sortParameters = new SortParameters(sortBy, normalizedSortOrder);
