...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/Version-5.1.0-2563eb?style=for-the-badge">
  <img alt="Coverage" src="https://img.shields.io/badge/Coverage-92.1%25-16a34a?style=for-the-badge">
...
<p align="center">
  ...
  <img alt="Spring Boot" src="https://img.shields.io/badge/Spring%20Boot-3.5-16a34a?style=flat-square&logo=springboot&logoColor=white">
...
- 🔐 **JWT Token Authentication**: Ensures enhanced security by implementing JSON Web Tokens, providing a reliable and
  secure authentication mechanism to safeguard applications from unauthorized access. Supports **Refresh Token Rotation** and **Incident Tracking**.
- 🔏 **Data Encryption**: Sensitive data, including tokens in the database, are encrypted using AES encryption for maximum security.
...
- 📊 **Custom Metrics**: Extensive monitoring with Micrometer, tracking authentication success rates, token usage, and latencies.
...
2. **Configuration (Environment Variables)**
   ...
   APP_JWT_CONFIRMATION_EXPIRATION=86400000
   APP_JWT_SESSION_EXPIRATION=2592000000
   ALLOWED_APPS_HEADERS=nebula_rest_api
   NEBULA_CONFIRMATION_MAIL_URL=https://your-frontend.com/confirm
...
3. **Build and Run**
   ...
   # Run the application
   java -jar target/andromeda-authorization-server-5.0.0.war
   ```
